...
use App\Controller\CreateCommentImageAction;
...
class CommentImages
{
     ...
     * @var File|null
     *
     * @Assert\NotNull(groups={"commentimage_object_create"})
     * @Vich\UploadableField(mapping="commentImages", fileNameProperty="filePath")
     */
    public $file;
